...
//         >
//           {[
//             { label: "All", value: total, color: "#1976d2" },
//             { label: "Pending", value: pending, color: "#d32f2f" },
//             { label: "In Progress", value: inProgress, color: "#f9a825" },
//             { label: "Completed", value: completed, color: "#2e7d32" },
//           ].map(k => (
//             <Card key={k.label} sx={{ borderLeft: `6px solid ${k.color}` }}>
//               <CardContent>
...
//             </Typography>
//             <Typography mt={1}>
//               No {filter === "all" ? "" : filter.replace("-", " ")} tasks at the moment.
//             </Typography>
//           </Box>
//         )}
